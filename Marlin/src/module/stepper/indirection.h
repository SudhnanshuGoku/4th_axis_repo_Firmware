...
#define PNEUMATIC 0x00
#define INKJET 0x01
#define MELT 0x02

#define CUSTOM_CHECK_EXTR(X, Y) (X == Y)
...
#define E0_STEP_INIT() SET_OUTPUT(E0_STEP_PIN)
  ...
  #define E0_STEP_WRITE(STATE) {if (CUSTOM_CHECK_EXTR(CUSTOM_E0_TYPE, INKJET)) WRITE(E0_STEP_PIN,!STATE);\
                                else WRITE(E0_STEP_PIN,STATE);}
#endif
...
#define E1_STEP_INIT() SET_OUTPUT(E1_STEP_PIN)
  ...
  #define E1_STEP_WRITE(STATE) {if (CUSTOM_CHECK_EXTR(CUSTOM_E1_TYPE, INKJET)) WRITE(E1_STEP_PIN,!STATE);\
                                else WRITE(E1_STEP_PIN,STATE);}
#endif
...
#define E2_STEP_INIT() SET_OUTPUT(E2_STEP_PIN)
  ...
  #define E2_STEP_WRITE(STATE) {if (CUSTOM_CHECK_EXTR(CUSTOM_E2_TYPE, INKJET)) WRITE(E2_STEP_PIN,!STATE);\
                                else WRITE(E2_STEP_PIN,STATE);}
#endif
...
#define E3_STEP_INIT() SET_OUTPUT(E3_STEP_PIN)
  ...
  #define E3_STEP_WRITE(STATE) {if (CUSTOM_CHECK_EXTR(CUSTOM_E3_TYPE, INKJET)) WRITE(E3_STEP_PIN,!STATE);\
                                else WRITE(E3_STEP_PIN,STATE);}
#endif
...
#define E4_STEP_INIT() SET_OUTPUT(E4_STEP_PIN)
  ...
  #define E4_STEP_WRITE(STATE) {if (CUSTOM_CHECK_EXTR(CUSTOM_E4_TYPE, INKJET)) WRITE(E4_STEP_PIN,!STATE);\
                                else WRITE(E4_STEP_PIN,STATE);}
#endif
...
#define E5_STEP_INIT() SET_OUTPUT(E5_STEP_PIN)
  ...
  #define E5_STEP_WRITE(STATE) {if (CUSTOM_CHECK_EXTR(CUSTOM_E5_TYPE, INKJET)) WRITE(E5_STEP_PIN,!STATE);\
                                else WRITE(E5_STEP_PIN,STATE);}
#endif
...
//
  ...
  #define  ENABLE_STEPPER_E0() ({\
    if (CUSTOM_CHECK_EXTR(CUSTOM_E0_TYPE, MELT)) TERN(HAS_E0_ENABLE, E0_ENABLE_WRITE( E_ENABLE_ON), NOOP);\
    else TERN(HAS_E0_ENABLE, E0_ENABLE_WRITE(!E_ENABLE_ON), NOOP);\
    if (CUSTOM_CHECK_EXTR(CUSTOM_E0_TYPE, INKJET)) NORM_E_DIR(0);})
#endif
#ifndef DISABLE_STEPPER_E0
  #define DISABLE_STEPPER_E0() ({\
    if (CUSTOM_CHECK_EXTR(CUSTOM_E0_TYPE, MELT)) TERN(HAS_E0_ENABLE, E0_ENABLE_WRITE(!E_ENABLE_ON), NOOP);\
    else TERN(HAS_E0_ENABLE, E0_ENABLE_WRITE( E_ENABLE_ON), NOOP);\
    if (CUSTOM_CHECK_EXTR(CUSTOM_E0_TYPE, INKJET)) {E0_STEP_WRITE(1);REV_E_DIR(0);}})
#endif

#ifndef ENABLE_STEPPER_E1
  #if (E_STEPPERS > 1 || ENABLED(E_DUAL_STEPPER_DRIVERS)) && HAS_E1_ENABLE
    #define  ENABLE_STEPPER_E1() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E1_TYPE, MELT)) E1_ENABLE_WRITE(E_ENABLE_ON);\
      else E1_ENABLE_WRITE(!E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E1_TYPE, INKJET)) NORM_E_DIR(1);})
  #else
  ...
  #if (E_STEPPERS > 1 || ENABLED(E_DUAL_STEPPER_DRIVERS)) && HAS_E1_ENABLE
    #define DISABLE_STEPPER_E1() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E1_TYPE, MELT)) E1_ENABLE_WRITE(!E_ENABLE_ON);\
      else E1_ENABLE_WRITE(E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E1_TYPE, INKJET)) {E1_STEP_WRITE(1);REV_E_DIR(1);}})
  #else
    ...
    #define  ENABLE_STEPPER_E2() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E2_TYPE, MELT)) E2_ENABLE_WRITE(E_ENABLE_ON);\
      else E2_ENABLE_WRITE(!E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E2_TYPE, INKJET)) NORM_E_DIR(2);})
  #else
  ...
  #if E_STEPPERS > 2 && HAS_E2_ENABLE
    #define DISABLE_STEPPER_E2() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E2_TYPE, MELT)) E2_ENABLE_WRITE(!E_ENABLE_ON);\
      else E2_ENABLE_WRITE(E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E2_TYPE, INKJET)) {E2_STEP_WRITE(1);REV_E_DIR(2);}})
  #else
    ...
    #define  ENABLE_STEPPER_E3() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E3_TYPE, MELT)) E3_ENABLE_WRITE(E_ENABLE_ON);\
      else E3_ENABLE_WRITE(!E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E3_TYPE, INKJET)) NORM_E_DIR(3);})
  #else
  ...
  #if E_STEPPERS > 3 && HAS_E3_ENABLE
    #define DISABLE_STEPPER_E3() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E3_TYPE, MELT)) E3_ENABLE_WRITE(!E_ENABLE_ON);\
      else E3_ENABLE_WRITE(E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E3_TYPE, INKJET)) {E3_STEP_WRITE(1);REV_E_DIR(3);}})
  #else
    ...
    #define  ENABLE_STEPPER_E4() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E4_TYPE, MELT)) E4_ENABLE_WRITE(E_ENABLE_ON);\
      else E4_ENABLE_WRITE(!E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E4_TYPE, INKJET)) NORM_E_DIR(4);})
  #else
  ...
  #if E_STEPPERS > 4 && HAS_E4_ENABLE
    #define DISABLE_STEPPER_E4() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E4_TYPE, MELT)) E4_ENABLE_WRITE(!E_ENABLE_ON);\
      else E4_ENABLE_WRITE(E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E4_TYPE, INKJET)) {E4_STEP_WRITE(1);REV_E_DIR(4);}})
  #else
    ...
    #define  ENABLE_STEPPER_E5() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E5_TYPE, MELT)) E5_ENABLE_WRITE(E_ENABLE_ON);\
      else E5_ENABLE_WRITE(!E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E5_TYPE, INKJET)) NORM_E_DIR(5);})
  #else
  ...
  #if E_STEPPERS > 5 && HAS_E5_ENABLE
    #define DISABLE_STEPPER_E5() ({\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E5_TYPE, MELT)) E5_ENABLE_WRITE(!E_ENABLE_ON);\
      else E5_ENABLE_WRITE(E_ENABLE_ON);\
      if (CUSTOM_CHECK_EXTR(CUSTOM_E5_TYPE, INKJET)) {E5_STEP_WRITE(1);REV_E_DIR(5);}})
  #else
