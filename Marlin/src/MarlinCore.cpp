...
//    SETUP_RUN(servo2_init());
  ...
  marlin_state = MF_RUNNING;
    ...
    SET_OUTPUT(CUSTOM_LED_PIN);
    OUT_WRITE(CUSTOM_LED_PIN, CUSTOM_LED_STATE);
  #endif
  #ifdef CUSTOM_UV_PIN
    SET_OUTPUT(CUSTOM_UV_PIN);
    OUT_WRITE(CUSTOM_UV_PIN, !CUSTOM_UV_STATE);
  #endif
  #ifdef CUSTOM_HEPA_PIN
    SET_OUTPUT(CUSTOM_HEPA_PIN);
    OUT_WRITE(CUSTOM_HEPA_PIN, !CUSTOM_HEPA_STATE);
  #endif
  #ifdef CUSTOM_FAN_PIN
    SET_OUTPUT(CUSTOM_FAN_PIN);
    OUT_WRITE(CUSTOM_FAN_PIN, !CUSTOM_FAN_STATE);
  #endif
  #ifdef CUSTOM_CLE0_PIN
    SET_OUTPUT(CUSTOM_CLE0_PIN);
    OUT_WRITE(CUSTOM_CLE0_PIN, !CUSTOM_CLE0_STATE);
  #endif
  #ifdef CUSTOM_CLE1_PIN
    SET_OUTPUT(CUSTOM_CLE1_PIN);
    OUT_WRITE(CUSTOM_CLE1_PIN, !CUSTOM_CLE1_STATE);
  #endif
  #ifdef CUSTOM_CLE2_PIN
    SET_OUTPUT(CUSTOM_CLE2_PIN);
    OUT_WRITE(CUSTOM_CLE2_PIN, !CUSTOM_CLE2_STATE);
  #endif
  #ifdef CUSTOM_CLE3_PIN
    SET_OUTPUT(CUSTOM_CLE3_PIN);
    OUT_WRITE(CUSTOM_CLE3_PIN, !CUSTOM_CLE3_STATE);
  #endif
  #ifdef CUSTOM_CLE4_PIN
    SET_OUTPUT(CUSTOM_CLE4_PIN);
    OUT_WRITE(CUSTOM_CLE4_PIN, !CUSTOM_CLE4_STATE);
  #endif
  #ifdef CUSTOM_CLE5_PIN
    SET_OUTPUT(CUSTOM_CLE5_PIN);
    OUT_WRITE(CUSTOM_CLE5_PIN, !CUSTOM_CLE5_STATE);
  #endif
  #ifdef CUSTOM_HEATBED
    SET_OUTPUT(CUSTOM_HEATBED);
    OUT_WRITE(CUSTOM_HEATBED, !CUSTOM_BED_STATE);
  #endif
  #ifdef CUSTOM_HEATE0
    SET_OUTPUT(CUSTOM_HEATE0);
    OUT_WRITE(CUSTOM_HEATE0, !CUSTOM_E0_STATE);
  #endif
  #ifdef CUSTOM_HEATE1
    SET_OUTPUT(CUSTOM_HEATE1);
    OUT_WRITE(CUSTOM_HEATE1, !CUSTOM_E1_STATE);
  #endif
  #ifdef CUSTOM_HEATE2
    SET_OUTPUT(CUSTOM_HEATE2);
    OUT_WRITE(CUSTOM_HEATE2, !CUSTOM_E2_STATE);
  #endif
  #ifdef CUSTOM_HEATE3
    SET_OUTPUT(CUSTOM_HEATE3);
    OUT_WRITE(CUSTOM_HEATE3, !CUSTOM_E3_STATE);
  #endif
  #ifdef CUSTOM_HEATE4
    SET_OUTPUT(CUSTOM_HEATE4);
    OUT_WRITE(CUSTOM_HEATE4, !CUSTOM_E4_STATE);
  #endif
  #ifdef CUSTOM_HEATE5
    SET_OUTPUT(CUSTOM_HEATE5);
    OUT_WRITE(CUSTOM_HEATE5, !CUSTOM_E5_STATE);
  #endif
  
  
  #ifdef MOVE_SERVO
  	int servo_index = 0;
  	while (servo_index < NUM_SERVOS) MOVE_SERVO(servo_index ++, 0);
  #endif
