 ...
 */
  ...
  #elif SWITCHING_NOZZLE_SERVO_NR == 4 && !PIN_EXISTS(SERVO4)
    #error "SERVO4_PIN must be defined for your SWITCHING_NOZZLE."
  #elif SWITCHING_NOZZLE_SERVO_NR == 5 && !PIN_EXISTS(SERVO5)
    #error "SERVO5_PIN must be defined for your SWITCHING_NOZZLE."
  #elif SWITCHING_NOZZLE_SERVO_NR == 6 && !PIN_EXISTS(SERVO6)
    #error "SERVO6_PIN must be defined for your SWITCHING_NOZZLE."
  #endif
      ...
      #error "SERVO3_PIN must be defined for your SWITCHING_NOZZLE."
    #elif SWITCHING_NOZZLE_E1_SERVO_NR == 4 && !PIN_EXISTS(SERVO4)
      #error "SERVO4_PIN must be defined for your SWITCHING_NOZZLE."
    #elif SWITCHING_NOZZLE_E1_SERVO_NR == 5 && !PIN_EXISTS(SERVO5)
      #error "SERVO5_PIN must be defined for your SWITCHING_NOZZLE."
    #elif SWITCHING_NOZZLE_E1_SERVO_NR == 6 && !PIN_EXISTS(SERVO6)
      #error "SERVO6_PIN must be defined for your SWITCHING_NOZZLE."
    #endif
  #endif
#endif
 ...
 */
  ...
  #elif SWITCHING_NOZZLE_E1_SERVO_NR == 4 && !PIN_EXISTS(SERVO4)
    #error "SERVO4_PIN must be defined for your SWITCHING_EXTRUDER."
  #elif SWITCHING_NOZZLE_E1_SERVO_NR == 5 && !PIN_EXISTS(SERVO5)
    #error "SERVO5_PIN must be defined for your SWITCHING_EXTRUDER."
  #elif SWITCHING_NOZZLE_E1_SERVO_NR == 6 && !PIN_EXISTS(SERVO6)
    #error "SERVO6_PIN must be defined for your SWITCHING_EXTRUDER."
  #endif
  #if EXTRUDERS > 3
    #if NUM_SERVOS < 2
 ...
 */
   ...
   */
    ...
    #elif Z_PROBE_SERVO_NR == 4 && !PIN_EXISTS(SERVO4)
      #error "SERVO4_PIN must be defined for your servo or BLTOUCH probe."
    #elif Z_PROBE_SERVO_NR == 5 && !PIN_EXISTS(SERVO5)
      #error "SERVO5_PIN must be defined for your servo or BLTOUCH probe."
    #elif Z_PROBE_SERVO_NR == 6 && !PIN_EXISTS(SERVO6)
      #error "SERVO6_PIN must be defined for your servo or BLTOUCH probe."
    #endif
  #endif
